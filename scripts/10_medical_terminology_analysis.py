...
# -*- coding: utf-8 -*-
"""
10_medical_terminology_analysis.py

Model-based discovery of clinical entities in the DocTalk corpus.

Purpose
-------
This script replaces a purely rule/seed-list based terminology analysis with an
open-source model-based extraction of candidate diagnoses, symptoms, medications,
...
---------------------
python scripts/10_medical_terminology_analysis.py \
  --corpus both \
  --backend all \
  --min_score 0.50 \
