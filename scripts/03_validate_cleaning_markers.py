...
Run from the project root directory:
    ...
    python scripts/03_validate_cleaning_markers.py --corpus direct
    python scripts/03_validate_cleaning_markers.py --corpus group
    python scripts/03_validate_cleaning_markers.py --corpus both
