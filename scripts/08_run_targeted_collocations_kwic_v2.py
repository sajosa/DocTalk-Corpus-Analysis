...
CATEGORY_HINTS = {
    ...
    "MT_Gruppe": "Therapy/group context",
    "GT_Gruppe": "Therapy/group context",
    "KT_Gruppe": "Therapy/group context",
...
ARTICLE_PROFILE_SEEDS = [
    ...
    },
    {
        ...
        "Expected anchors": "Rückmeldung; Gruppe; MT; GT; KT; MT_Gruppe; GT_Gruppe; KT_Gruppe; anwesend",
        "Dominant modality": "Group",
...
def summarize_for_article(
    ...
    profile_map = {
        ...
        "Therapy/group documentation and attendance": [  "Rückmeldung", "Gruppe", "MT", "GT", "KT", "MT_Gruppe", "GT_Gruppe", "KT_Gruppe", "anwesend"],
...
def _write_outputs(
    ...
    """
    output_dir.mkdir(parents=True, exist_ok=True)
    xlsx_path = output_dir / "targeted_collocations_kwic_results_clean_lexical_v2.xlsx"
    ...
    csv_dir = output_dir / "targeted_collocations_kwic_results_clean_lexical_v2_csv"
...
def parse_cli_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--utterances",
        type=Path,
        default=Path("outputs/confidential/cleaned_corpus_tables/utterances_for_collocation_clean_lexical_v2.csv"),
